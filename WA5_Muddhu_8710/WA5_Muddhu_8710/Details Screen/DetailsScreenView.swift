...
class DetailsScreenView: UIView {
    ...
    func initConstraints(){
        NSLayoutConstraint.activate([
            ...
            labelName.topAnchor.constraint(equalTo: imagePhoto.bottomAnchor, constant: 16),
            ...
            labelAddress.topAnchor.constraint(equalTo: labelPhoneNumber.bottomAnchor, constant: 25),
